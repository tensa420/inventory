...
const file_inventory_proto_rawDesc = "" +
	"\n" +
	"\x0finventory.proto\x12\finventory.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"$\n" +
	...
	"\awebsite\x18\x03 \x01(\tR\awebsite\"\x8d\x01\n" +
	"\x05Value\x12!\n" +
	...
	"\n" +
	"bool_value\x18\x04 \x01(\bR\tboolValue*r\n" +
	"\bCategory\x12\x14\n" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseB\x18Z\x16pkg/pb/inventory/v1;v1b\x06proto3"
